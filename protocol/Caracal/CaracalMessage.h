...
public:
  static std::size_t new_read_message(Message &message, ITable &table,
    ...
    auto message_piece_header = MessagePiece::construct_message_piece_header(
        static_cast<uint32_t>(CaracalMessage::READ_REQUEST), message_size,
  ...
  static std::size_t new_write_message(Message &message, ITable &table,
    ...
    auto message_piece_header = MessagePiece::construct_message_piece_header(
        static_cast<uint32_t>(CaracalMessage::WRITE_REQUEST), message_size,
        table.tableID(), table.partitionID());
...
public:
  ...
  read_request_handler(MessagePiece inputPiece, Message &responseMessage,
    ...
    DCHECK(inputPiece.get_message_type() ==
           static_cast<uint32_t>(CaracalMessage::READ_REQUEST));
    ...
    auto message_piece_header = MessagePiece::construct_message_piece_header(
        static_cast<uint32_t>(CaracalMessage::READ_RESPONSE), message_size,
  ...
  read_response_handler(MessagePiece inputPiece, Message &responseMessage,
    ...
    DCHECK(inputPiece.get_message_type() ==
           static_cast<uint32_t>(CaracalMessage::READ_RESPONSE));
    auto table_id = inputPiece.get_table_id();
    auto partition_id = inputPiece.get_partition_id();
    DCHECK(table_id == table.tableID());
    DCHECK(partition_id == table.partitionID());
  ...
  write_request_handler(MessagePiece inputPiece, Message &responseMessage,
                        ...
                        std::vector<std::unique_ptr<Transaction>> &txns) {
    DCHECK(inputPiece.get_message_type() ==
           static_cast<uint32_t>(CaracalMessage::WRITE_REQUEST));
    auto table_id = inputPiece.get_table_id();
    auto partition_id = inputPiece.get_partition_id();
    DCHECK(table_id == table.tableID());
    DCHECK(partition_id == table.partitionID());
